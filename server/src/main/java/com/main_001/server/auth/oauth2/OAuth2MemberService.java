...
public class OAuth2MemberService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        return new DefaultOAuth2User(Collections.singleton(new SimpleGrantedAuthority("USER")), oAuth2Attribute.getAttributes(), oAuth2Attribute.getNameAttributeKey());
    }
...
//        }
        ...
        String nickname = attributes.getProvider().toUpperCase() + "_" + email.substring(0, email.indexOf("@"));
        String phone = email.substring(0, 13);
